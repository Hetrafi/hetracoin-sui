...
async function testHetrafi() {
  ...
  console.log('Testing Hetrafi module...');
  ...
  tx.moveCall({
    ...
    arguments: [
      tx.pure(walletAddress), // Use the wallet address as the treasury address
    ],
  });
...
testHetrafi().catch(console.error); 